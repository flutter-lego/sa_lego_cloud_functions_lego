...
import '../../../app/backend/callable_functions/_new/_.dart';
import '../../../app/backend/firebase_auth/login_email_password/_.dart';
import '../../../app/backend/firebase_auth/login_google/_.dart';
import '../../../main.dart';
...
T _button01 = T("01", onTap: (BuildContext context) async {
  ////////////////////////////////////////
  ResponseNew? response = await NewCallableFunctions.request(RequestNew()..docId = 'example2'..s000 = "sky is blue");
