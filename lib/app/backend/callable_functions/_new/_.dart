...
class RequestNew {
  ...
  String toDataString() {
    return base64.encode(utf8
        .encode(Uri(scheme: 'https', host: 'junestory.com', queryParameters: {
      's000': s000,
      // 's001': s001,
      // 's002': s002,
      // 's003': s003,
  ...
  static RequestNew fromDataString(String dataString) {
    Map<String, String> queryParams =
    Uri.splitQueryString(utf8.decode(base64.decode(dataString)));

    RequestNew object = RequestNew();
  ...
  static RequestNew fromMap(Map<dynamic, dynamic> queryParams) {
    RequestNew object = RequestNew();
...
class ResponseNew {
  ...
  static ResponseNew fromDataString(String dataString) {
    Map<String, String> queryParams =
    Uri.splitQueryString(utf8.decode(base64.decode(dataString)));

    ResponseNew object = ResponseNew();
...
class NewCallableFunctions {
  static Future<ResponseNew?> request(RequestNew object) async {
    try {
      final result = await FirebaseFunctions.instance
          .httpsCallable('newCallableFunctions')
          .call({"text": object.toDataString()});

      return ResponseNew.fromDataString(result.data);
